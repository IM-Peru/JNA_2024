...
ggplot(
  saldo_diario |> 
    mutate(Entries = fct_relevel(Entries, c("entries_max_1", "entries_min_1", "entries_mean_1")),
                Exits = fct_relevel(Exits, c("exits_mean_1", "exits_min_1", "exits_max_1"))),
  aes(
    x = Exits,
    y = Entries
  )
...
# Plot
ggplot(stock_proj_1 |> 
         mutate(type = fct_relevel(type, c("mean", "min", "max")),
...
ggplot(
  saldo_diario |> 
    mutate(Entries = fct_relevel(Entries, c("entries_max_2", "entries_min_2", "entries_mean_2")),
                Exits = fct_relevel(Exits, c("exits_mean_2", "exits_min_2", "exits_max_2"))),
  aes(
    x = Exits,
    y = Entries
  )
