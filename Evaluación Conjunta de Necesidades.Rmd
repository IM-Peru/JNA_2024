...
```{r echo = FALSE}
setwd("C:/Users/GARCIAAC/OneDrive - UNHCR/Desktop/R Projects/JNA/Evaluación Conjunta")
...
Indicator creation for the dimensions at the household level. Be careful since I did some adhoc adjustmets. For example creating the round_half_up function in step 3 and the variable SHE_D1_Q3_ALL in step 4. Indicator INT_D3 is built following the specific structure used under our XLS form. The structure of how the humanitarian transportation questions where asked is also specific to Peru.
...
Indicator creation for the dimensions at the individual or member of household level. Be careful since I did some adhoc adjustmets. For example creating the variable NUT_D10_Q1_ALL in step 5.
...
# Step 12. PIN Calculations

```{r}
# Subset and group the individual indicators from the Individual dataset at Household level to then merge them in one final dataset 
...
# Further coding needed to actually create the Deprivation Sector punctuation, MPI Punctuation and Intersectoral PIN and sectoral PIN


```

# Step 13. Removing and reorganizing columns

Output = for Dashboard purposes

```{r}

HH <- HH |>
  select("_index", "interviewdate", "implementador", "DEMO_1", "DEMO_2", "DEMO_00.6", "DEMO_5", 
         "DEMO_6", "DEMO_7", "country", "admin1", "admin2", "DEMO_18", "MH_1",
         "INT_D3_Q1", "INT_D3_Q1B", 
         ...
         "INT_D3_Q2_1", "INT_D3_Q2_2", "INT_D3_Q2_3", "INT_D3_Q2_4", "INT_D3_Q2_5", 
         "INT_D3_Q2_6", "INT_D3_Q2_7", "INT_D3_Q2_8",
         "INT_D3_Q2_9", "INT_D3_Q2_10", "INT_D3_Q2_98", "INT_D3_Q2_99", "INT_D3_Q2_O", "INT_D4_Q1", 
         "INT_D4_Q1_1", "INT_D4_Q1_2", "INT_D4_Q1_3", "INT_D4_Q1_4", "INT_D4_Q1_5", 
         "INT_D4_Q1_6", "INT_D4_Q1_10", "INT_D4_Q1_96",
         ...
         "FS_D4_Q6", "FS_D4_Q7", "FS_D4_Q8", "FS_D4_Q9", "FS_D4_Q10", 
         "HT_D1_Q1_first", "HT_D1_Q1_first_o",
         "HT_D1_Q1_second", "HT_D1_Q1_second_o", "HT_D1_Q2", "HT_D2_Q1", "HT_D2_Q1_O", 
         "SHE_D1_Q1", "SHE_D1_Q1_O", 
         ...
         "SHE_D1_Q3_3", "SHE_D1_Q3_4", "SHE_D1_Q3_5", "SHE_D1_Q3_98", "SHE_D1_Q3_99", 
         "SHE_D2_Q1", "SHE_D3_Q1",
         "SHE_D3_Q1_1", "SHE_D3_Q1_2", "SHE_D3_Q1_3", "SHE_D3_Q1_4", "SHE_D4_Q1", 
         "WA_D1_Q1", "WA_D1_Q2", "WA_D2_Q1", 
         "WA_D2_Q2", "WA_D4_Q1", "WA_D4_Q2", "WA_D6_Q1", "WA_D8_Q1", "WA_D11_Q1", "PRO_D1_Q1",
         "PRO_D1_Q1_1", "PRO_D1_Q1_2", "PRO_D1_Q1_3", "PRO_D1_Q1_4", "PRO_D1_Q1_5",
         "PRO_D1_Q1_6", "PRO_D1_Q1_7",
         "PRO_D1_Q1_9", "PRO_D1_Q1_96", "PRO_D1_Q1_98", "PRO_D1_Q1_99", "PRO_D1_Q1_O", "PRO_D2_Q1",
         "PRO_D2_Q1B", "PRO_D2_Q1B_1", "PRO_D2_Q1B_2", "PRO_D2_Q1B_3", "PRO_D2_Q1B_4", 
         "PRO_D2_Q1B_5", "PRO_D2_Q1B_6",
         ...
         "PRO_D5_Q2", "PRO_D5_Q2_1", "PRO_D5_Q2_2", "PRO_D5_Q2_3", "PRO_D5_Q2_4", 
         "PRO_D5_Q2_5", "PRO_D5_Q2_6",
         "PRO_D5_Q2_7", "PRO_D5_Q2_98", "PRO_D5_Q2_99", "GBV_D1_Q1", "GBV_D1_Q1B", 
         "GBV_D1_Q1B_1", "GBV_D1_Q1B_2",
         ...
         "HTS_D1_Q2", "HTS_D2_Q1", "HTS_D2_Q1_1", "HTS_D2_Q1_2", "HTS_D2_Q1_3", 
         "HTS_D2_Q1_4", "HTS_D2_Q1_5",
         "HTS_D2_Q1_6", "CP_D1_Q1", "CP_D1_Q1_1", "CP_D1_Q1_2", "CP_D1_Q1_3", 
         "CP_D1_Q1_4", "CP_D1_Q1_5", "CP_D1_Q1_6", 
         "CP_D1_Q1_7", "CP_D1_Q1_98", "CP_D1_Q1_99", "CP_D1_Q2", "psea3", "_id",
         "__version__", "_uuid", "rpt_hhmnames_count", "SECTOR", "SHE_D1_Q3_ALL", 
         "INT_D3", "INT_D4", "SHE_D1", 
         "SHE_D2", "SHE_D3", "SHE_D4", "WA_D1", "WA_D2", "WA_D4", "WA_D6", "WA_D8", "WA_D11", "HT_D1",
         "FCS", "FCG", "FCS_4pt", "FS_D1", "R_CSI", "r_CSI_categories", "FCS_rCSI", 
         "FS_D2", "FES", "Foodexp_4pt",
         "FS_D3", "stress_coping", "crisis_coping", "emergency_coping", "Max_coping_behaviour",
         "FS_D4", "Mean_coping_capacity_FES", "CARI_unrounded_FES", "CARI_FES", "PRO_D1", 
         "PRO_D2", "PRO_D3",
...
# Step 14. Exporting the datasets
...
data_listed<-list("HH" = HH, "Individual" = Individual, "Data_final" = Data_final)

write_xlsx(data_listed, paste0("JNA Peru ", date_time, ".xlsx"))
