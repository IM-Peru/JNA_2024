...
```{r}
# write_xlsx(pins_indicator, "pins_indicator2.xlsx")
...
HH <- HH |>
  select("_index", "interviewdate", "implementador", "DEMO_1", "DEMO_2", "DEMO_00.6", "DEMO_5", 
         ...
         "GBV_D1_Q1B_96", "GBV_D1_Q1B_98", "GBV_D1_Q1B_99", "GBV_D1_Q1B_O", "GBV_D3_Q1", "HTS_D1_Q1", 
...
Individual <- Individual |>
  select("hhmnames_pos", "HH03", "HH04", "HH05", "HH07", "HH07_months", "Age_Group", "MH_3", "MH_3_1", "MH_3_2", "MH_3_3", 
...
```{r message = FALSE, warning = FALSE}
sheet_list <- list(HH, Individual)

write_xlsx(sheet_list, "JNA_dashboard.xlsx")
